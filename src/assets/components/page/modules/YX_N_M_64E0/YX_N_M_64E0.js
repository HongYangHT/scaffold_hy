(function() {
            ...
            self.getAjaxData('https://spread.mail.163.com/mail/goods/getGroup', {
                ...
                $.each(onShelf, function(k, v) {
                    ...
                    _html += [
                        ...
                        '<p class="u-64E0-desc">' + (_detail.extend.maker ? _detail.extend.maker :_detail.simpleDesc) + '</p>',
    ...
    $('.YX-N-M-64E0 .J_module_info ').each(function(i, n) {
        ...
        myModule.getGoodsRender($(n).closest('.YX-N-M-64E0'), _id, window.psc_act_id, needScenePicUrl, _needGoodsNum);
    });
