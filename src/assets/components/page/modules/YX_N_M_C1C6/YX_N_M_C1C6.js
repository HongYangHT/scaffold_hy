(function() {
               ...
               for(var i=0; i<_goods.length;i++){
                ...
                $.each(onShelf,function(k,v){
                    ...
                    _html += [
                            ...
                            '<a href="http://you.163.com/item/detail?id=' + v.id + '&&_stat_subject=' + _subject + '" target="_blank" class="u-C1C6-link PSC_J_normal_statistics_Goods">',
                            ...
                            '<span class="u-C1C6-offPrice">' + v.notSoldOutGoods.price + '</span>',
                            (parseFloat(v.notSoldOutGoods.price) >= parseFloat(v.unitPrice) ? '' : '<span class="u-C1C6-unitPrice">' + v.unitPrice + '</span>'),
                            '</p>',
                            ...
                            '<a href="javascript:;" target="_self" class="u-C1C6-cart J_C1C6_cart PSC_J_normal_statistics_Goods PSC_C_statistics_'+ sellVolumeId +'" data-skuId="' + sellVolumeId + '" data-img="' + v.primaryPicUrl + '"></a>',
                            '</div>',
                            '</div>',
                            '</div>'
                        ].join('');
                ...
                $(element).find('.u-C1C6-goods').remove();
    ...
    $('.YX-N-M-C1C6 .J_module_info ').each(function(i, n) {
        ...
        myModule.getGoodsRender($(n).closest('.YX-N-M-C1C6'), _id, window.psc_act_id,needScenePicUrl,_needGoodsNum);
    });
    ...
    $('body').on('click', '.YX-N-M-C1C6 .PSC_J_normal_statistics_Goods', function(e) {
