(function() {
            ...
            self.getAjaxData('https://spread.mail.163.com/mail/goods/getGroup', {
                ...
                $.each(onShelf, function(k, v) {
                    ...
                    _html += [
                        ...
                        '<p class="u-77DE-desc">' + (_detail.extend.maker ? _detail.extend.maker :_detail.simpleDesc) + '</p>',
    ...
    $('.YX-N-M-77DE .J_module_info ').each(function(i, n) {
        ...
        myModule.getGoodsRender($(n).closest('.YX-N-M-77DE'), _id, window.psc_act_id, needScenePicUrl, _needGoodsNum);
    });
