...
define([
    ...
    var _default = {
        contentInfo: {
            ...
            middleLeftUrl:'https://you.163.com/item/detail?id=1092021&from=web_mailo_old_old_2',
            middleRightUrl:'https://you.163.com/item/detail?id=1092021&from=web_mailo_old_old_2',
            ...
            imgMiddleLeft:'https://mimg.127.net/hz/uploader/20161207/14811076570390719.jpg',
            imgMiddleRight:'https://mimg.127.net/hz/uploader/20161207/14811076570390719.jpg',
    ...
    var YX_N_M_9E49 = Vue.extend({
        ...
        watch: {
            ...
            'contentInfo.middleLeftUrl.value': {
                'handler': function(value, old) {
                    var data = {
                        'contentInfo': {
                            'middleLeftUrl': {
            ...
            'contentInfo.middleRightUrl.value': {
                'handler': function(value, old) {
                    var data = {
                        'contentInfo': {
                            'middleRightUrl': {
            ...
            'contentInfo.imgMiddleLeft.value': {
                'handler': function(value, old) {
                    var data = {
                        'contentInfo': {
                            'imgMiddleLeft': {
            ...
            'contentInfo.imgMiddleRight.value': {
                'handler': function(value, old) {
                    var data = {
                        'contentInfo': {
                            'imgMiddleRight': {
